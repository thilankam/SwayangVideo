...
public class Camera2VideoFragment extends Fragment implements View.OnClickListener {
    ...
    // Rotations are 90, 180, 270, 360=0,
    ...
    private TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        // SwayangRecord uses the onSurfaceTexture ( Entire screen will display the rendering video)
        // sizes of the screen width and height becomes the entire screen SurfaceTexture width and
        // height of the phone.
    ...
    private CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(CameraDevice cameraDevice) {
            ...
            startPreview(); // Starting the  preview
    ...
    private static Size chooseOptimalSize(Size[] choices, int width, int height, Size aspectRatio) {
        ...
        int w = aspectRatio.getWidth(); // get the width

        int h = aspectRatio.getHeight(); // get the height
        ...
        if (bigEnough.size() > 0) {
            ...
            Log.e(TAG, "Couldn't find any suitable preview size"); // Error message to appear on
            return choices[0];
        }
    }
